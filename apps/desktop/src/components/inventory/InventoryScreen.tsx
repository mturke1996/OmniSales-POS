...
import { findExactCatalogMatch } from "../../lib/catalog";
...
export function InventoryScreen({
  ...
  const [draftBarcode, setDraftBarcode] = useState<string | undefined>();
